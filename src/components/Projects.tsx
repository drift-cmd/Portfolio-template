    ...
    <section className="py-20 px-6 relative">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          */}
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            A sample showcase of work, layout, and content that can be customized for your own portfolio
          </p>
        </motion.div>
        ...
        >
          <p className="text-gray-400 mb-6">
            Ready to personalize this section? Replace the examples with your own projects and goals.
          </p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
