      ...
      <div className="max-w-7xl mx-auto">
          ...
          >
            <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                This contact section is just an example. Replace it with your real details, preferred contact method, and a short message that fits your brand.
              </p>
            </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="text-green-400 font-semibold">Ready for your next update</span>
              </div>
              <p className="text-gray-400 mt-2">
                This status message is ready to be replaced with your real availability.
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        >
          <p className="text-gray-400">
            © 2025 Example Studio. Built with React & Tailwind CSS
          </p>
        </motion.div>
      </div>
    </section>
